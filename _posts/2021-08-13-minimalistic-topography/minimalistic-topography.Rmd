...
preview: minimalistic_topography.png
twitter: 
  site: "@NRatnaweera"
  author: "@NRatnaweera"
output:
...
Like Bauhasaurus, I found this a very nice approach and tried recreating this idea with R for my home country, Switzerland. Check below to see the source code.
...
knitr::include_graphics("minimalistic_topography.png")
```
